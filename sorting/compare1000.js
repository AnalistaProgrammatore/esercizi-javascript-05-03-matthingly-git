...
var numElements = oneHundNums.length;
var nums = new CArray(numElements, oneHundNums);
...
start = new Date().getTime();
oneHundNums.sort(function(a, b){return 0.5 - Math.random()});
stop = new Date().getTime();
elapsed = stop - start;

console.log("Elapsed time for the random sort on " + numElements + " elements is: " + elapsed + " milliseconds.");