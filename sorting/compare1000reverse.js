...
let oneHundNumsReverse = []
for (let i = 1000; i > 0; i--) {
  oneHundNumsReverse.push(i)
}

var numElements = oneHundNumsReverse.length;
var nums = new CArray(numElements, oneHundNumsReverse);
...
//il bubble sort è sempre quello con tempo maggiore di tutti (tra gli 8 e i 9 ms);
